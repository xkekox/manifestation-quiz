async function hashEmail(email) {async function hashEmail(email) {
        try {
                    const encoder = new TextEncoder();async function hashEmail(email) {
                                try {
                ...
                async function submitEmail() {
                            ...
                            const affId = "&aff=jefersonkeko15e9cd";

                            const finalURL = baseAffiliate + utmParams + affId;
